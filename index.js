...
(async () => {
  ...
  await page.goto("https://github.com/markwylde?tab=repositories", {
  ...
  while (isThereMorePage) {
    repositories = [...repositories, ...await page.evaluate(() => {
      return [
        ...
        return {
          ...
          forks:
            [...repository.querySelectorAll("a.Link--muted.mr-3")]
              .filter((a) =>
                a.querySelector("svg").classList.contains("octicon-repo-forked")
              )
